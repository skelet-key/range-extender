...
Range-extender schematics and notes for an F150 Lightning project. Currently documentation-light (README-first). Prefer clear diagrams, BOM notes, and safety-minded electrical guidance when adding content.
